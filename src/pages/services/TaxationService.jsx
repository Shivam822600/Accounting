...
const TaxationService = () => {
  const data = services.find((s) => s.slug === "taxation") || {
  ...
  return (
    <main className="bg-white">
      ...
      <Hero
        ...
        image="https://rpsaccountants.com.au/wp-content/uploads/2026/01/GST-BAS-Services-in-Australia-1024x576.jpg"
      />
        ...
        <div className="container-page grid gap-12 lg:grid-cols-[1fr_1.3fr] lg:items-start">
          ...
          <aside className="lg:sticky lg:top-28 rounded-2xl bg-mint p-8 shadow-sm">
            ...
            <div className="border-t border-navy/10 pt-6">
              <p className="text-xs font-bold uppercase text-navy/60 tracking-wider">Lodgement Specialties</p>
              <div className="flex flex-wrap gap-2 mt-3">
                {["Sole Trader", "Company Tax", "Partnership", "Trust Returns"].map((type) => (
                  <span key={type} className="bg-white px-3.5 py-1.5 rounded-md text-xs font-bold text-navy shadow-sm">
                    {type}
                  </span>
                ))}
              </div>
          ...
          <div>
            <div className="mb-10">
              <SectionHeader
                eyebrow="Expert Tax Agents"
                title="Registered TPB Tax Return Specialists"
              />
      ...
      <CTASection title="Ready to prepare your taxation return?" />
    </main>
  );
};
